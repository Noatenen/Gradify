const KEY = 'motiva-mentor-workspace-v1';
...
export const DEFAULT_DATA = {
  ...
  projects: [
    {
      id: 'p1', name: 'ניווט לעיוורים', team: 'רועי כהן, שני מור', milestone: 'אב־טיפוס', owner: 'מנטור', status: 'at_risk',
    ...
    {
      id: 'p2', name: 'מסמכי תיעוד למערכת', team: 'איתי שם־טוב', milestone: 'תיעוד טכני', owner: 'מנטור', status: 'attention',
